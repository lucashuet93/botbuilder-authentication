...
var BotAuthenticationMiddleware = /** @class */ (function () {
    ...
    */
    ...
    BotAuthenticationMiddleware.prototype.initializeRedirectEndpoints = function () {
        ...
        this.server.get("/" + this.tenantId + "/" + this.botId + "/auth/failure", function (req, res, next) {
            res.json("Authentication Failed");
        });
        //passport providers ultimately redirect here
        this.server.get("/" + this.tenantId + "/" + this.botId + "/auth/callback", function (req, res, next) {
    ...
    BotAuthenticationMiddleware.prototype.initializePassportProviders = function () {
        ...
        if (this.authenticationConfig.facebook) {
            ...
            this.server.get("/" + this.tenantId + "/" + this.botId + "/auth/facebook/callback", passport.authenticate('facebook', {
        ...
        if (this.authenticationConfig.azureADv1 || this.authenticationConfig.azureADv2) {
            ...
            var url_1 = "/" + this.tenantId + "/" + this.botId + "/auth/callback";
            this.server.get("/" + this.tenantId + "/" + this.botId + "/auth/azureAD", passport.authenticate('azuread-openidconnect'));
            this.server.get("/" + this.tenantId + "/" + this.botId + "/auth/azureAD/callback", passport.authenticate('azuread-openidconnect', options), function (req, res, next) {
            ...
            ;
            this.server.post("/" + this.tenantId + "/" + this.botId + "/auth/azureAD/callback", passport.authenticate('azuread-openidconnect', options), function (req, res, next) {
                _this.serverType === ServerType_1.ServerType.Express ? res.redirect(url_1, 302) : res.redirect(302, url_1, next);
            });
            ;
        }
    ...
    BotAuthenticationMiddleware.prototype.createAuthorizationUris = function () {
        ...
        if (this.authenticationConfig.facebook)
            authorizationUris.push({ provider: BotAuthenticationConfiguration_1.ProviderType.Facebook, authorizationUri: this.baseUrl + "/" + this.tenantId + "/" + this.botId + "/auth/facebook" });
        if (this.authenticationConfig.google)
            authorizationUris.push({ provider: BotAuthenticationConfiguration_1.ProviderType.Google, authorizationUri: this.baseUrl + "/" + this.tenantId + "/" + this.botId + "/auth/google" });
        if (this.authenticationConfig.twitter)
            authorizationUris.push({ provider: BotAuthenticationConfiguration_1.ProviderType.Twitter, authorizationUri: this.baseUrl + "/" + this.tenantId + "/" + this.botId + "/auth/twitter" });
        if (this.authenticationConfig.github)
            authorizationUris.push({ provider: BotAuthenticationConfiguration_1.ProviderType.Github, authorizationUri: this.baseUrl + "/" + this.tenantId + "/" + this.botId + "/auth/github" });
        if (this.authenticationConfig.azureADv1 || this.authenticationConfig.azureADv2) {
